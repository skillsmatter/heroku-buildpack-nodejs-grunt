...
Create a new app with this buildpack:
    ...
    heroku create myapp --buildpack https://github.com/skillsmatter/heroku-buildpack-nodejs-grunt.git

Or add this buildpack to your current app:

    heroku config:add BUILDPACK_URL=https://github.com/skillsmatter/heroku-buildpack-nodejs-grunt.git
